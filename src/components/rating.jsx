...
const Rating = () => {
  ...
  return (
    <section
      className={`fixed top-0 left-0 flex items-center justify-center w-full h-full ${fadeIn ? 'fade-in' : ''}`}
    >
      <div className={`relative max-w-sm bg-white border rounded-lg shadow cta-rating-main ${fadeIn ? 'fade-in' : ''}`}>
